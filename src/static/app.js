      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantItems = participants.length
          ? participants
              .map(
                (participant) => `
                  <div class="participant-row">
                    ...
                    <button class="participant-remove-btn" data-activity="${name}" data-email="${participant}" title="Remove ${participant}">
                      ✕
                    </button>
                  </div>
                `
              ...
              .join("")
          : '<div class="participants-empty">No one has joined yet — be the first!</div>';
